...
import com.fanqie.core.entity.SysUserRoleEntity;
import com.fanqie.core.service.SysUserRoleService;
...
public class UserLoginController {
    ...
    public SWJsonResult login(@RequestBody SysUserEntity sysUserEntity){
        ...
        try{
            ...
            new SWJsonResult(map);;
        } catch (AuthenticationException e) {
            map.put("code",500);
            map.put("msg","该用户不存在");
            return new SWJsonResult(map);
        } catch (Exception e) {
            map.put("code",500);
            map.put("msg","未知异常");
            return new SWJsonResult(map);
    ...
    public SWJsonResult testAddUser(){
        // 设置基础参数
